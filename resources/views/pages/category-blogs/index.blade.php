@section('title', 'Madjou | Category-blog')
<x-app-layout>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h4 class="card-title">Tabel Categories blog</h4>
                                        ...
                                        <form id="modalFormData" name="modalFormData" class="form-horizontal"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    placeholder="Input name category blog..." value="">
    ...
    <script>
        ...
        $(() => {
            $('#btn-add').click(function (e) { 
                e.preventDefault();
                $("#title").html("add data category blog");
                $("#btn-save").val("add");
                $("#put").html("");
